...
export class SegmentService {
  ...
  findAll(): Observable<Segment[]> {
    return this.http.get<Segment[]>(`${Config.webApiUrl}/segment`);
  }

  findById(id: any): Observable<Segment> {
    return this.http.get<Segment>(`${Config.webApiUrl}/segment/${id}`);
  }

  create(segment: Segment): Observable<Segment> {
    return this.http.post<Segment>(`${Config.webApiUrl}/segment`, segment);
  }
  ...
  delete(id: string): Observable<Segment> {
    return this.http.delete<Segment>(`${Config.webApiUrl}/segment/${id}`);
  }
}
